        ...
        public void OnActionExecuted(ActionExecutedContext context) {
            ...
            if(parameters != null) { 
                ...
                if (parameters.ContainsKey("sortBy"))
                    personsController.ViewData["CurrenSortBy"] = Convert.ToString(parameters["sortBy"]);
                else {
                    personsController.ViewData["CurrenSortBy"] = nameof(PersonResponse.PersonName);
                }
                if (parameters.ContainsKey("sortOrder"))
                    personsController.ViewData["CurrenSortOrder"] = Convert.ToString(parameters["sortOrder"]);
                else {
                    personsController.ViewData["CurrenSortOrder"] = nameof(SortOrderOptions.ASC);
                }
            }
